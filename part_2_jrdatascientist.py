...
scaler = MinMaxScaler()
numerical_columns = ['Age', 'PersonsNights', 'AverageLeadTime', 'LodgingRevenue', 'OtherRevenue', 'DaysSinceLastStay']
...
"""# **Dataset Analysis Post-Cleaning**"""
...
"""# **Splitting Features and Target** / **Handling Class Imbalance** / **Standardizing Features**"""
...
"""# **Neural Network Model** / **Early Stopping and Learning Rate Scheduler** / **Model Training** / **Visualizing Training Performance** / **Model Evaluation**"""
...
# Regex to extract
numbers = re.findall(r'"id":(\d+)|"code":(\d+)', text)
# Flatten the list of tuples and filter out empty strings
numbers = [int(num) for pair in numbers for num in pair if num]
print(numbers) #extracted all the numbers with orange color background from the document text.